...
import cv2
import logging
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QHBoxLayout, QPushButton, QWidget, QLabel, QLCDNumber, QFileDialog, QTextEdit, QDialog, QDialogButtonBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.front_video_button = QPushButton("Select Front Video")
        self.front_video_button.clicked.connect(self.select_front_video)
        
        self.rear_video_button = QPushButton("Select Rear Video")
        self.rear_video_button.clicked.connect(self.select_rear_video)
        ...
        self.main_layout.addWidget(self.front_video_button)
        self.main_layout.addWidget(self.rear_video_button)
    ...
    def select_front_video(self):
        video_source, _ = QFileDialog.getOpenFileName(self, "Select Front Video")
        if video_source:
            self.front_camera_widget.set_video_source(video_source)

    def select_rear_video(self):
        video_source, _ = QFileDialog.getOpenFileName(self, "Select Rear Video")
        if video_source:
